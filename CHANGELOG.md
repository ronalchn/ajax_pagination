...
* Convert ajax_section method to return symbol instead of string, and using symbols for both sections and actions internally (strings passed into methods will be converted into symbols)
* Rewrote ajax_section class method to add default_render behaviour which checks for AJAX requests in a more efficient way
